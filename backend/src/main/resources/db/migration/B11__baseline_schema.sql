-- Clean-install baseline for schema state after V11.
-- Keep historical V1-V11 migrations untouched for existing environments.
...
INSERT INTO users (email, password_hash, display_name, locale, credit_balance, invite_code, username, onboarding_status)
VALUES
    ('alice@example.com', 'dev-password-hash', 'Alice', 'zh-TW', 50, 'INV-ALICE1', 'alice', 'DONE'),
    ('bob@example.com', 'dev-password-hash', 'Bob', 'en', 50, 'INV-BOB001', 'bob', 'DONE')
